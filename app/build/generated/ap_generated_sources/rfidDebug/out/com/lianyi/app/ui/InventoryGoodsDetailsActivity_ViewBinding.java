...
public class InventoryGoodsDetailsActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public InventoryGoodsDetailsActivity_ViewBinding(InventoryGoodsDetailsActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public InventoryGoodsDetailsActivity_ViewBinding(final InventoryGoodsDetailsActivity target,
      View source) {
    this.target = target;
    ...
    target.svGoodsName = Utils.findRequiredViewAsType(source, R.id.sv_goods_name, "field 'svGoodsName'", AppCompatTextView.class);
    target.svGoodsSpecifications = Utils.findRequiredViewAsType(source, R.id.sv_goods_specifications, "field 'svGoodsSpecifications'", AppCompatTextView.class);
    target.svGoodsUnit = Utils.findRequiredViewAsType(source, R.id.sv_goods_unit, "field 'svGoodsUnit'", SuperTextView.class);
    target.etGoodsNumber = Utils.findRequiredViewAsType(source, R.id.et_goods_number, "field 'etGoodsNumber'", AppCompatTextView.class);
    ...
    target.etGoodsBarcode = Utils.findRequiredViewAsType(source, R.id.et_goods_barcode, "field 'etGoodsBarcode'", AppCompatTextView.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    InventoryGoodsDetailsActivity target = this.target;
