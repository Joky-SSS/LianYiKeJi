...
public class InventoryNewGoodsActivity_ViewBinding implements Unbinder {
  private InventoryNewGoodsActivity target;
  ...
  @UiThread
  public InventoryNewGoodsActivity_ViewBinding(InventoryNewGoodsActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public InventoryNewGoodsActivity_ViewBinding(final InventoryNewGoodsActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    InventoryNewGoodsActivity target = this.target;
