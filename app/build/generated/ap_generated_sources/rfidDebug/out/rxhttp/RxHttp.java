...
import com.lianyi.app.utils.ResponseParser;
...
public class RxHttp<P extends Param, R extends RxHttp> extends BaseRxHttp {
  ...
  private P addDefaultDomainIfAbsent(P param) {
    String newUrl = addDomainIfAbsent(param.getSimpleUrl(), ApiService.API_BASE);
    param.setUrl(newUrl);
    return param;
  }

  public R setDomainToIportalIfAbsent() {
    String newUrl = addDomainIfAbsent(param.getSimpleUrl(), ApiService.API_IPORTAL);
    param.setUrl(newUrl);
    return (R)this;
  }

  public R setDomainToLoginIfAbsent() {
    String newUrl = addDomainIfAbsent(param.getSimpleUrl(), ApiService.API_LOGIN);
    param.setUrl(newUrl);
    return (R)this;
  }
